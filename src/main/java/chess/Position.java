...
public class Position {
    ...
    public Position(String colrow) {
        ...
        if (MIN_COLUMN > column && column > MAX_COLUMN && MIN_ROW > row && row > MAX_ROW) {
            throw new PositionValidationException("Invalid input");
        }
    }
    ...
    public Position getPosition(int columnOffset, int rowOffset) {
        int column = this.column + columnOffset;
